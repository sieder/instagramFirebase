...
class HomePostCell: UICollectionViewCell {
    ...
    let captionLabel: UILabel = {
        ...
        attributedText.append(NSAttributedString(string: "Some caption txt that will perhaps wrap onto the next line", attributes: [NSAttributedStringKey.font: UIFont.boldSystemFont(ofSize: 14)]))
    ...
    override init(frame: CGRect) {
        ...
        usernameLabel.anchor(top: topAnchor, left: userProfileImageView.rightAnchor, bottom: photoImageView.topAnchor, right: optionButton.rightAnchor, paddingTop: 0, paddingLeft: 8, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
